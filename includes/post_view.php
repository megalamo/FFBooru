<?php
	...
	else
	{
		...
		foreach($ttags as $current)
		{
			...
			echo '<li><span style="color: #a0a0a0;">? <a href="index.php?page=post&amp;s=list&amp;tags='.htmlentities($current).'" class="generic">'.str_replace('_',' ',$current)."</a> ".$count['index_count']."</span></li>";
		}
