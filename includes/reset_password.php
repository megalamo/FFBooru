<?php
	...
	if(isset($_POST['username']) && $_POST['username'] != "")
	{
		...
		{	
			...
			if($row['email'] != "" && $row['email'] != NULL && str_contains($row['email'],"@") && str_contains($row['email'],".") && strlen($row['email']) > 2)
			{		
				$misc = new misc();
				$code = hash('sha256',bin2hex(random_bytes(128)).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()).mt_rand(0,mt_getrandmax()));
	...
	if(isset($_POST['new_password']) && $_POST['new_password'] != "" && isset($_SESSION['tmp_id']) && $_SESSION['tmp_id'] != "" && is_numeric($_SESSION['tmp_id'])  && isset($_SESSION['reset_code']) && trim($_SESSION['reset_code']) != "" && $_SESSION['reset_code'] != "null")
	{
		...
		if($result->num_rows() > 0)
		{
			...
			$query = "UPDATE $user_table SET mail_reset_code = NULL WHERE id='$id' AND mail_reset_code='$code'";
			$db->query($query);
